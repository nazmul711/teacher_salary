	...
	<section class="salary-section">
       ...
       <div class="postion_salay">
           ...
           <div class="maincontain">
			   ...
			   <?php
					if($_SERVER['REQUEST_METHOD']=="POST"){
						...
						elseif($M_name != $link){
							...
							$insert_T = "INSERT INTO tbl_mount (link, name,teacher_salary) VALUES('$L_mounth', '$M_name',NULL)";
			   ...
			   <h2 style="background:#E4dd58; margin-top:50px;">
					<a style="text-decoration:none; font-size:16px; text-align:center;" href="copy_M.php">Copy All Data Previus Mouth</a>
			   </h2>
           </div>
        </div>   
