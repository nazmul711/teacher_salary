					...
					if($_SERVER['REQUEST_METHOD']=="POST"){
						...
						empty($H_rent) || empty($Treatment) || empty($Vehicular) || 
						 empty($F_Found)){
							...
							$insert_T = "INSERT INTO June (name, incre_Date, Orgin_Salary, incre_Yearly, Last_Y_increse, H_rent, Treatment, Vehicular, 2nd_shift_fee, incre_Honoraria, Festival_bonus, F_Found) 
							VALUES
